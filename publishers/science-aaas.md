...
6 feeds generated from `data/feeds.json`.

| Journal | Subjects | Status | Method | Feed | Source | Notes |
| --- | --- | --- | --- | --- | --- | --- |
| Science | multidisciplinary, science | verified | publisher_index | [RSS](https://www.science.org/action/showFeed?type=etoc&feed=rss&jc=science) | [source](https://www.science.org/journal/science) |  |
